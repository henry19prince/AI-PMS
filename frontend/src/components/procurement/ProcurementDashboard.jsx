// src/components/procurement/ProcurementDashboard.jsx (Converted from Dashboard.jsx, using Recharts and MUI)
...
const ProcurementDashboard = () => {
  ...
  const chartData = [
    ...
    { name: "Delivered PO", value: data.delivered_po, fill: "#F59E0B" },
  ];
  ...
  return (
    <>
      ...
      <Grid container spacing={3} sx={{ mb: 4 }}>
        ...
        <Grid item xs={12} sm={6} md={4}><StatCard title="Delivered POs" value={data.delivered_po} color="warning" /></Grid>
